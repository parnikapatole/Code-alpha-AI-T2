...
try:
    ...
    st.error("Missing 'faqs.json' file. Please create it in the root folder.")
    st.stop()

# --- 4. NLP ENGINE (TF-IDF + Cosine Similarity) ---
# ngram_range(1,2) allows the bot to understand both single words and pairs of words.
...
if user_query:
    ...
    # Show answer only if similarity is above 25%
    if score > 0.25:
        ...
        st.warning("Confidence too low. Please rephrase your question to be more specific.")